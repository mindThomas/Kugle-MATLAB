...
[data, vicon] = TrimSynced(data, vicon, 29, 35); % full = 29 length 78
...
disturbance_times = [18.08, 26.94, 33.53, 54.51];
...
% csvwrite_with_headers('zero_balance_nonagressive_vicon.csv', out, headers);
% 
...
% csvwrite_with_headers('zero_balance_nonagressive_system.csv', out, headers);
% 
% % Store disturbance times
% csvwrite_with_headers('zero_balance_nonagressive_disturbances.csv', {disturbance_times'}, {'time'});