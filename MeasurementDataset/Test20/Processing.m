...
[data, vicon] = TrimSynced(data, vicon, 65, 58.78);
...
csvwrite_with_headers('inclination_rotation_test_nonaggressive_vicon.csv', out, headers);
...
csvwrite_with_headers('inclination_rotation_test_nonaggressive_system.csv', out, headers);