...
DumpFolder = [pwd '/'];
data = LoadDump(DumpFolder, '', 20, 50);

%% Remove mean from measurements
data.raw_accelerometer = data.raw_accelerometer - mean(data.raw_accelerometer);
data.mti_accelerometer = data.mti_accelerometer - mean(data.mti_accelerometer);
data.raw_gyroscope = data.raw_gyroscope - mean(data.raw_gyroscope);
data.mti_gyroscope = data.mti_gyroscope - mean(data.mti_gyroscope);
