...
[data, vicon] = TrimSynced(data, vicon, 14.2+5.5, 40); % station_keeping_aggressive_with_initial
%[data, vicon] = TrimSynced(data, vicon, 19.75+7, 10); % station_keeping_aggressive
...
csvwrite_with_headers('station_keeping_aggressive_with_initial_vicon.csv', out, headers);
...
csvwrite_with_headers('station_keeping_aggressive_with_initial_system.csv', out, headers);