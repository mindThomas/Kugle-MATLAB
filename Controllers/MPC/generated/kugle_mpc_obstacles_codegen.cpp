...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    IntermediateState intS16 = (-s+trajectoryLength);
    IntermediateState intS17 = (-obs1_r+sqrt(((-obs1_x+x)*(-obs1_x+x)+(-obs1_y+y)*(-obs1_y+y))));
    IntermediateState intS18 = (-obs2_r+sqrt(((-obs2_x+x)*(-obs2_x+x)+(-obs2_y+y)*(-obs2_y+y))));
    IntermediateState intS19 = (-obs3_r+sqrt(((-obs3_x+x)*(-obs3_x+x)+(-obs3_y+y)*(-obs3_y+y))));
    IntermediateState intS20 = (-obs4_r+sqrt(((-obs4_x+x)*(-obs4_x+x)+(-obs4_y+y)*(-obs4_y+y))));
    IntermediateState intS21 = (-obs5_r+sqrt(((-obs5_x+x)*(-obs5_x+x)+(-obs5_y+y)*(-obs5_y+y))));
    IntermediateState intS22 = (exp((-intS17+proximityOffset)*proximityScale)+exp((-intS18+proximityOffset)*proximityScale)+exp((-intS19+proximityOffset)*proximityScale)+exp((-intS20+proximityOffset)*proximityScale)+exp((-intS21+proximityOffset)*proximityScale));
    ...
    acadodata_f3 << intS16;
    acadodata_f3 << intS22;
    IntermediateState intS23 = (angle_slack+sin(5.00000000000000000000e-01*maxAngle));
    ...
    ocp1.subjectTo((-intS23+q2) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((-intS23-q2) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((-intS23+q3) <= 0.00000000000000000000e+00);
    ocp1.subjectTo((-intS23-q3) <= 0.00000000000000000000e+00);
    ocp1.subjectTo(angle_slack >= 0.00000000000000000000e+00);
    ...
    ocp1.subjectTo((intS21+proximity_slack) >= 0.00000000000000000000e+00);
