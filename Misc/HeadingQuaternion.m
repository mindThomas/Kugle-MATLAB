function q_heading = HeadingQuaternion(q)
    ...
    % Construct heading quaternion
    q_heading = [cos(heading/2);
                 0;
                 0;
                 sin(heading/2)];
             
    if (q(1) < 0) % scalar is negative, make sure this is the case in the output quaternion too
        q_heading = -q_heading;
	end